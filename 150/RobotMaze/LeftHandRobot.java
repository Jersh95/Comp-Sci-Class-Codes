 ...
 *Override the chooseMoveDirection method that will try to make the robot move left, then try straight, then try right, then as a last resort turn around
...
{
	//the robot is facing south to begin with
	...
	public int chooseMoveDirection() 
	{
		...
		if(this.getDirectionFacing() == 'S')
		{
			...
			//if it cannot move left or straight, it will try to move right, west
		...
		{
			//checks left, west, first if it can move there
			if(checkCell(this.getCurrentRow(), this.getCurrentColumn() - 1) == true)
			{
				direction = 2;
				this.setDirectionFacing('W');
			...
			//if it cannot move left or straight, it will try to move right, east
			else if(checkCell(this.getCurrentRow(), this.getCurrentColumn() + 1) == true)
			{
				direction = 3;
				this.setDirectionFacing('E');
		...
		{
			//checks left, south, first if it can move there
			if(checkCell(this.getCurrentRow() + 1, this.getCurrentColumn()) == true)
			{
				direction = 1;
				this.setDirectionFacing('S');
			}
			//if it cannot move left, it will try to move straight
			else if(checkCell(this.getCurrentRow(), this.getCurrentColumn() - 1) == true)
			{
				direction = 2;
				this.setDirectionFacing('W');
			}
			//if it cannot move left or straight, it will try to move right, south
			else if(checkCell(this.getCurrentRow() - 1, this.getCurrentColumn()) == true)
			{
				direction = 0;
				this.setDirectionFacing('N');
		...
		{
			//checks left, north, first if it can move there
			if(checkCell(this.getCurrentRow() - 1, this.getCurrentColumn()) == true)
			{
				direction = 0;
				this.setDirectionFacing('N');
